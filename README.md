...
* Combined multiple Kaggle datasets(soil properties, crop recommendation, and fertilizer data) to build a comprehensive AI model that improves real-world reliability.
* Integrated a sustainability scoring system that ranks fertilizers based on eco-impact and soil health preservation.
* Designed a multi-model AI approach, merging CNN (for image-based soil analysis) and ML regression/classification models (for data-based predictions).
* Developed an interactive and multilingual web platform to make the solution accessible to farmers worldwide.
